...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We regret to inform you that your offer has been rejected by our admin team.</p>
            
            <div class="offer-details">
                <h3>{{ $offer->product_name }}</h3>
                <p><strong>Reason for Rejection:</strong> {{ $reason }}</p>
                <p><strong>Posted on:</strong> {{ $offer->created_at->format('F d, Y') }}</p>
            </div>
            
            <p>You can review the offer and make necessary changes before resubmitting for approval.</p>
