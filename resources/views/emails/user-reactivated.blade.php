...
<head>
    ...
    <title>Account Reactivated - Job Portal</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px; border-radius: 10px;">
        ...
        <div style="padding: 30px;">
            ...
            <p>Great news! Your account on <strong>Job & Offer Portal</strong> has been <strong>reactivated</strong> by our admin team.</p>
            ...
            <p>You can now log in and use all platform features again.</p>
