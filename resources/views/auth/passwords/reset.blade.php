...
@section('subheader', 'Enter a new password below')
...
@section('content')
<div class="reset-container d-flex align-items-center justify-content-center py-5">
            ...
            <div class="col-xl-5 col-lg-6 col-md-8">
                <div class="reset-card">
                    <div class="card-header-gradient text-white">
                        ...
                        <h3 class="mb-2 fw-bold">Reset Your Password</h3>
                        <p class="mb-0 opacity-90">Choose a strong new password</p>
                    </div>
